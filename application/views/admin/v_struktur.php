    ...
    <?php if ($this->session->flashdata('success')): ?>
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <form action="<?php echo base_url('admin/profil_sekolah/edit_struktur'); ?>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Foto <?php echo($breadcrumb) ; ?></h6>
                </div>
                <div class="card-body">
