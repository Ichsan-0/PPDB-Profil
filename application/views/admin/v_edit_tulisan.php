...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="col-xl-4 col-lg-5">
                  ...
                  <option value="">-Pilih-</option>
        				  <?php
        					foreach ($kat->result_array() as $i) {
                               ...
                               // Cek apakah kategori ini harus di-exclude
                               if (!in_array($kategori_id, $exclude_ids)) {
                                   // Hanya tampilkan kategori yang belum pernah dipilih atau yang sedang dipilih
                                   if($b['tulisan_kategori_id']==$kategori_id || !in_array($kategori_id, [7, 8])) {
                                      echo "<option value='$kategori_id'".($b['tulisan_kategori_id']==$kategori_id ? " selected" : "").">$kategori_nama</option>";
                                   }
                               }
                  }?>
                </select>
              ...
              <?php if($b['tulisan_gambar']): ?>
                    <img src="<?php echo base_url('assets/images/'.$b['tulisan_gambar']); ?>" width="100%">
                <?php endif; ?>
                </div>
              </div>
            </div>
