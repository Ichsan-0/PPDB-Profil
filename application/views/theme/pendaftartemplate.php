...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url('');?>style/img/logo-sma.jpg">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <?php $this->load->view('theme/pendaftarnavigation'); ?>
    <!-- End of Sidebar -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <footer class="sticky-footer bg-white">
        <?php $this->load->view('theme/pendaftarfooter'); ?>
      </footer>
      <!-- End of Footer -->
...
<!-- Your existing slim version of jQuery -->
...
<script src="<?php echo base_url('');?>assets/metronic/assets/demo/default/custom/components/forms/widgets/bootstrap-datepicker.js"></script>
