<footer class="footer">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <img width="150" src="<?= get_school_logo(); ?>" class="rounded" alt="Logo Sekolah">
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p>Call Center : <?php echo get_phone(); ?></p>
                            </div>
                        </div>
                        <div class="media contact-info">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> Muhammad Ichsan</p>
                        </p>
                    </div>
                </div>
            </div>
